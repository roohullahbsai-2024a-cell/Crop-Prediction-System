...
def assess_confidence(score, crop):
    ...
    if score > 80.0:
        return {
            ...
            "alert_msg": f"Optimal match detected across SVM, Random Forest, and XGBoost. This field provides the best soil nutrients and environmental climate for cultivating {crop_display}."
        }
    elif score >= 60.0:
        return {
            "tier": "better",
            ...
            "alert_msg": f"Favorable conditions detected across the three models. Soil and climate are better suited for {crop_display} with solid yield potential."
        }
    elif score >= 40.0:
        return {
            "tier": "fine",
            ...
            "alert_msg": f"Moderate match detected. Conditions are fine for {crop_display}, but not better. Soil amendments or irrigation adjustments are recommended."
        }
    else:
        return {
            "tier": "low",
            ...
            "alert_msg": f"Low fertility detected. Soil or climate is non-fertile/poor for standard cultivation, but {crop_display} is the most resilient and best match among all 22 crops."
        }
